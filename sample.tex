...
\logo[width=2cm]{Images/unicamp.png}
\supervisor{Master Yoda}
\title[Guerra nas estrelas]{\large Star Wars}
...
\backcover{
	...
	second language={
		Tese apresentada ao \thesecondaryinstitute~da \thesecondaryuniversity~como 
		parte dos requisitos exigidos para a obtenção do título de \uppercase{Mestre Jedi}, 
		na Àrea de \uppercase{Jedi Guardião}.
	}, 
	version text={
...
\newcommand{\thetestii}{}
\newcommand{\test}[2][]{
	\renewcommand{\thetesti}{#2}
	\renewcommand{\thetestii}{#1}
}
...
\thetest \thetest[2] \thetest[1] \thetest[]
