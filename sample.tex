...
\facepagetext{Tese de Doutorado apresentada ao \theinstitute da \theuniversity como parte dos requisitos exigidos para a obtenção do título de Doutor em Ciências.}


% {Dissertação/Tese apresentada à \theinstitute da \theuniversity como parte dos requisitos exigidos para a obtenção do título de Mestre(a)/Doutor(a) em <NOME DO TÍTULO>, na Àrea de <NOME DA ÁREA>}

% {Dissertation/ Thesis presented to the Faculty/Institute of the University of Campinas in partial fulfillment of the requirements for the degree of Master/Doctor, in the area of <NAME OF AREA>}
...
\abstractname{Resumo}
\begin{abstract}
% [SKYWALKER, Luke. \textbf{Guerra nas Estrelas}. Campinas, 2021. Tese de Doutorado -- \theinstitute, \theuniversity, \thelocation, \theyear.]
\lipsum[1-2]
\end{abstract}
...
\begin{abstract}
% [SKYWALKER, Luke. \textbf{\thetitle}. \thelocation, 2021. Tese de Doutorado -- \theinstitute, \theuniversity, \thelocation, \theyear.]
\lipsum[1-2]
\end{abstract}
