...
\maketitle
\backcover{
	first language={Thesis presented to the \theinstitute~of the \theuniversity~in partial fulfillment of the requirements for the degree of Doctor in Science, in the area of Physics},
	second language={Tese apresentada ao \theinstitute~da \theuniversity~como parte dos requisitos exigidos para a obtenção do título de Doutor em Ciências, na Àrea de Física},
	version text={Este trabalho corresponde à versão final da tese defendida pelo aluno \theauthor~e orientada pelo Prof. Dr. \thesupervisor.}
}
