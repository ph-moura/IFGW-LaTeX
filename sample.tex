...
\logo[align=center]{Images/unicamp.png}
...
\backcover{
	first text={
		...
		fulfillment of the requirements for the de\-gree of \uppercase{Mas\-ter Jedi}, 
		in the area of \uppercase{Jedi Guardian}.
	},
	second text={
		Tese apresentada ao \theinstitute[2]~da \theuniversity[2]~como parte dos 
		requisitos exigidos para a obtenção do título de \uppercase{Mestre Jedi}, 
		na Área de \uppercase{Jedi Guardião}.
	}, 
	version text={
		Es\-te tra\-ba\-lho cor\-res\-pon\-de à ver\-são fi\-nal da te\-se de\-fen\-di\-da pe\-lo 
		a\-lu\-no \theauthor~e ori\-en\-ta\-da pe\-lo Prof. Dr. \thesupervisor.
	}
}
